...
- (void)_setupSubviews
{
    ...
    _backgroundImageView.image = [ImageWithName(@"messageToolbarBg") stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    NSString *str = [[NSBundle bundleWithURL:[[NSBundle bundleForClass:[EaseChineseToPinyin class]] URLForResource:@"EaseUIResource.bundle" withExtension:nil]] localizedStringForKey:@"message.toolBar.inputPlaceHolder" value:@"" table:nil];
    ...
    [styleChangeButton setImage:ImageWithName(@"chatBar_record") forState:UIControlStateNormal];
    [styleChangeButton setImage:ImageWithName(@"chatBar_keyboard") forState:UIControlStateSelected];
    ...
    [self.recordButton setBackgroundImage:[ImageWithName(@"chatBar_recordBg") stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[ImageWithName(@"chatBar_recordSelectedBg") stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    ...
    [self.faceButton setImage:ImageWithName(@"chatBar_face") forState:UIControlStateNormal];
    [self.faceButton setImage:ImageWithName(@"chatBar_faceSelected") forState:UIControlStateHighlighted];
    [self.faceButton setImage:ImageWithName(@"chatBar_keyboard") forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:ImageWithName(@"chatBar_more") forState:UIControlStateNormal];
    [self.moreButton setImage:ImageWithName(@"chatBar_moreSelected") forState:UIControlStateHighlighted];
    [self.moreButton setImage:ImageWithName(@"chatBar_keyboard") forState:UIControlStateSelected];
