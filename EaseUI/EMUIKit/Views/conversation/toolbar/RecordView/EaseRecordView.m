...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _recordAnimationView.image = ImageWithName(@"VoiceSearchFeedback001");
...
-(void)setVoiceImage {
    ...
    if (0 < voiceSound <= 0.05) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback001")];
    }else if (0.05<voiceSound<=0.10) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback002")];
    }else if (0.10<voiceSound<=0.15) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback003")];
    }else if (0.15<voiceSound<=0.20) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback004")];
    }else if (0.20<voiceSound<=0.25) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback005")];
    }else if (0.25<voiceSound<=0.30) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback006")];
    }else if (0.30<voiceSound<=0.35) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback007")];
    }else if (0.35<voiceSound<=0.40) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback008")];
    }else if (0.40<voiceSound<=0.45) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback009")];
    }else if (0.45<voiceSound<=0.50) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback010")];
    }else if (0.50<voiceSound<=0.55) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback011")];
    }else if (0.55<voiceSound<=0.60) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback012")];
    }else if (0.60<voiceSound<=0.65) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback013")];
    }else if (0.65<voiceSound<=0.70) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback014")];
    }else if (0.70<voiceSound<=0.75) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback015")];
    }else if (0.75<voiceSound<=0.80) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback016")];
    }else if (0.80<voiceSound<=0.85) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback017")];
    }else if (0.85<voiceSound<=0.90) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback018")];
    }else if (0.90<voiceSound<=0.95) {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback019")];
    }else {
        [_recordAnimationView setImage:ImageWithName(@"VoiceSearchFeedback020")];
    }*/
}
