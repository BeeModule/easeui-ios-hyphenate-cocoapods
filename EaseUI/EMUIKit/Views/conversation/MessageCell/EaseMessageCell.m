                         ...
                         model:(id<IMessageModel>)model
{
    ...
    [_statusButton setImage:ImageWithName(@"messageSendFail") forState:UIControlStateNormal];
    ...
    if ([self respondsToSelector:@selector(isCustomBubbleView:)] && [self isCustomBubbleView:model]) {
        ...
        switch (messageType) {
            ...
            case EMMessageBodyTypeImage:
            {
                ...
                _bubbleView.imageView.image = ImageWithName(@"imageDownloadFail");
            }
                break;
            case EMMessageBodyTypeLocation:
            {
                ...
                _bubbleView.locationImageView.image = [ImageWithName(@"chat_location_preview") stretchableImageWithLeftCapWidth:10 topCapHeight:10];
            ...
            case EMMessageBodyTypeVideo:
            {
                ...
                _bubbleView.videoTagView.image = ImageWithName(@"messageVideo");
            }
                break;
            ...
            case EMMessageBodyTypeVoice:
            {
                if (_bubbleView.voiceImageView) {
                    if ([self.sendMessageVoiceAnimationImages count] > 0 && [self.recvMessageVoiceAnimationImages count] > 0) {
                        ...
                        self.bubbleView.voiceImageView.image = self.model.isSender ?ImageWithName(@"chat_sender_audio_playing_full"): ImageWithName(@"chat_receiver_audio_playing_full");
                    }
                }
